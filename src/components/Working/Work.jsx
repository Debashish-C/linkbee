...
const Work = () => {
  ...
  return (
    ...
    <div className="flex justify-around w-full h-full pt-20 mt-10 align-middle" >
      <div className="flex-col justify-center w-1/3 p-3 border-2 border-black rounded-md bg-slate-300" style={{color : color}}>
     <div className="flex justify-center">
      ...
      {/* designing */}
      <div className="w-1/2 h-full p-20 bg-slate-100">
        <div className="mb-8">
          <h2 className="font-mono text-4xl text-center">~ Start designing ~</h2>
        </div>
        <div className="flex-col justify-center align-middle">
            <h2 className="flex justify-start m-3 text-2xl font-bold">Background</h2>
        ...
        <div className="flex-col justify-center m-3 align-middle">
            <div className="">
                <h1 className="m-2 font-mono text-2xl font-bold">Profile Picture</h1>
            </div>
        ...
        <div className="">
            <div className="">
                <h2 className="p-3 m-4 mt-4 font-mono text-2xl font-bold"> Bio </h2>
            </div>
        ...
        <div className="mt-10">
            <div className="m-4">
                <h1 className="m-4 font-mono text-2xl font-bold">Link</h1>
            </div>
            <div className="flex justify-center p-4 m-1 align-middle shadow-xl w-fit bg-slate-400 rounded-xl">
                <div className="p-2">
        ...
        {/* font */}
        <div className="m-3 mt-10 h-96">
            <div className="">
                <h2 className="font-mono text-2xl font-bold">Font</h2>
            </div>
        ...
        {/* font color */}
        <div className="flex-col justify-center align-middle">
            <h2 className="flex justify-start m-3 text-2xl font-bold">Font Color</h2>
            <div className="flex justify-center overflow-auto align-middle ">
            <div className="m-4">
