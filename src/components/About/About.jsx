...
const About = () => {
  return (
    <>
    <div className='flex-col justify-center w-full p-2 mt-20 mb-40 text-center align-middle'>
      <div>
        <h1 className='text-4xl font-bold md:text-6xl'>Unlock the Potential of<br/>
        Your Online Reach</h1>
      </div>
      <div className='flex justify-center mt-20 align-middle md:flex sm:flex'>
...
Engage" card={card2}
        ...
        </div><div className="flex justify-center p-16">
