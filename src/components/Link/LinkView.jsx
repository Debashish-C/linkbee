    ...
    <div>
      <div className="flex justify-around pb-3 mt-4 align-middle rounded-lg bg-slate-400">
            ...
            <div className="flex justify-center align-middle">
                <input type="text" className="w-40 p-2 mt-3 font-semibold text-center rounded-md outline-none md:w-72 sm:w-52 bg-slate-300" placeholder="enter the link" value={props.linked}/>
            </div>
            <div className="flex justify-center align-middle ">
