...
const LinkView = (props) => {
  return (
    <div>
      <div className="flex justify-around w-full pb-3 mt-4 align-middle rounded-2xl bg-slate-400 ">
             <div className="flex justify-center p-1 mt-2 align-middle">
                ...
                <img src={props.icon} alt="" className='w-10 h-10 m-2'/> 
            </div> 
            <div className="flex justify-center align-middle">
                <input type="text" className="w-full p-2 mt-3 font-semibold text-center rounded-md outline-none md:w-72 sm:w-52 bg-slate-400" placeholder="enter the link" value={props.linked}/>
            </div>
            <div className="flex justify-center align-middle ">
                <button className="pr-3 mt-4 text-xl md:pl-3 sm:pl-2 font-bol bg-slate-000 "><img src={editImg} alt="" className='m-2 w-7 h-7' /></button>
            </div>
            <div className="flex justify-center align-middle ">
                <button className="p-1 pr-3 mt-4 text-xl rounded-lg md:pl-3 sm:pl-1 font-bol bg-slate-000 " onClick={() => props.remove(props.index)}>

                    <img src={dlete} alt="" className='w-8 h-8' />
